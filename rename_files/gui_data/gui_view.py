...
#
# Created: Tue Apr 28 17:11:57 2015
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.treeWidget = QtGui.QTreeWidget(self.frameFiles)
    ...
    def retranslateUi(self, Form):
        ...
        self.treeWidget.headerItem().setText(0, QtGui.QApplication.translate("Form", "Project ID", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.headerItem().setText(1, QtGui.QApplication.translate("Form", "Simple/Complex", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.headerItem().setText(2, QtGui.QApplication.translate("Form", "Original Name", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.headerItem().setText(3, QtGui.QApplication.translate("Form", "New Name", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.headerItem().setText(4, QtGui.QApplication.translate("Form", "Included/Excluded", None, QtGui.QApplication.UnicodeUTF8))
        __sortingEnabled = self.treeWidget.isSortingEnabled()
        self.treeWidget.setSortingEnabled(False)
        self.treeWidget.topLevelItem(0).setText(0, QtGui.QApplication.translate("Form", "CAPS1010", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(0).setText(1, QtGui.QApplication.translate("Form", "Simple", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(0).setText(2, QtGui.QApplication.translate("Form", "ana109.tif", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(0).setText(3, QtGui.QApplication.translate("Form", "ANA_00181_prsv.jpg", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(0).setText(4, QtGui.QApplication.translate("Form", "Included", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).setText(0, QtGui.QApplication.translate("Form", "CAPS1011", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).setText(1, QtGui.QApplication.translate("Form", "Complex", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).setText(2, QtGui.QApplication.translate("Form", "ana110.tif .. ana113.tif", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).setText(3, QtGui.QApplication.translate("Form", "ANA_00182_001_prsv.jpg .. ANA_00182_004_prsv.jpg", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).setText(4, QtGui.QApplication.translate("Form", "Included", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).child(0).setText(2, QtGui.QApplication.translate("Form", "ana110.tif", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).child(0).setText(3, QtGui.QApplication.translate("Form", "ANA_00182_001_prsv.jpg", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).child(0).setText(4, QtGui.QApplication.translate("Form", "Included", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).child(1).setText(2, QtGui.QApplication.translate("Form", "ana111.tif", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).child(1).setText(3, QtGui.QApplication.translate("Form", "ANA_00182_002_prsv.jpg", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).child(1).setText(4, QtGui.QApplication.translate("Form", "Included", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).child(2).setText(2, QtGui.QApplication.translate("Form", "ana112.tif", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).child(2).setText(3, QtGui.QApplication.translate("Form", "ANA_00182_003_prsv.jpg", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).child(2).setText(4, QtGui.QApplication.translate("Form", "Included", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).child(3).setText(2, QtGui.QApplication.translate("Form", "ana113.tif", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).child(3).setText(3, QtGui.QApplication.translate("Form", "ANA_00182_004_prsv.jpg", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.topLevelItem(1).child(3).setText(4, QtGui.QApplication.translate("Form", "Included", None, QtGui.QApplication.UnicodeUTF8))
