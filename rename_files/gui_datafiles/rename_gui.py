...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame.setMaximumSize(QtCore.QSize(200, 9999999))
        ...
        self.preview_image = QtGui.QLabel(self.frame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.preview_image.sizePolicy().hasHeightForWidth())
        self.preview_image.setSizePolicy(sizePolicy)
        self.preview_image.setMinimumSize(QtCore.QSize(175, 0))
        self.preview_image.setMaximumSize(QtCore.QSize(175, 2000))
        self.preview_image.setFrameShape(QtGui.QFrame.NoFrame)
        self.preview_image.setText("")
        self.preview_image.setPixmap(QtGui.QPixmap("test.bmp"))
