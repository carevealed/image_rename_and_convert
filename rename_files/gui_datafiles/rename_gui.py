...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setMaximumSize(QtCore.QSize(1024, 16777215))
        ...
        self.gridLayout_5.addWidget(self.pushButton_update, 2, 0, 1, 2)
        ...
        Form.setTabOrder(self.pushButton_include, self.checkBox_IncludeReport)
