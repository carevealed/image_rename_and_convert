...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cb_searchType.setObjectName("cb_searchType")
        self.cb_searchType.addItem("")
        self.cb_searchType.addItem("")
        ...
        self.lbl_searchType.setObjectName("lbl_searchType")
        ...
        self.formLayout = QtGui.QFormLayout(self.frame_7)
        self.formLayout.setObjectName("formLayout")
        self.lbl_fileSize = QtGui.QLabel(self.frame_7)
        self.lbl_fileSize.setObjectName("lbl_fileSize")
        self.formLayout.setWidget(0, QtGui.QFormLayout.LabelRole, self.lbl_fileSize)
        self.le_fileSize = QtGui.QLineEdit(self.frame_7)
        self.le_fileSize.setEnabled(True)
        self.le_fileSize.setReadOnly(True)
        self.le_fileSize.setObjectName("le_fileSize")
        self.formLayout.setWidget(0, QtGui.QFormLayout.FieldRole, self.le_fileSize)
        ...
        self.formLayout.setWidget(1, QtGui.QFormLayout.FieldRole, self.le_resolution)
        self.lbl_resolution = QtGui.QLabel(self.frame_7)
        self.lbl_resolution.setObjectName("lbl_resolution")
        self.formLayout.setWidget(1, QtGui.QFormLayout.LabelRole, self.lbl_resolution)
        self.le_colorDepth = QtGui.QLineEdit(self.frame_7)
        self.le_colorDepth.setReadOnly(True)
        self.le_colorDepth.setObjectName("le_colorDepth")
        self.formLayout.setWidget(2, QtGui.QFormLayout.FieldRole, self.le_colorDepth)
        self.lbl_colorDepth = QtGui.QLabel(self.frame_7)
        self.lbl_colorDepth.setObjectName("lbl_colorDepth")
        self.formLayout.setWidget(2, QtGui.QFormLayout.LabelRole, self.lbl_colorDepth)
        ...
        self.lbl_colorDepth.setBuddy(self.le_colorDepth)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_title.setText(QtGui.QApplication.translate("Form", "CAPS Image Renaming and Conversion Script", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.cb_searchType.setItemText(0, QtGui.QApplication.translate("Form", "Smart", None, QtGui.QApplication.UnicodeUTF8))
        self.cb_searchType.setItemText(1, QtGui.QApplication.translate("Form", "All", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_load_filles.setText(QtGui.QApplication.translate("Form", "Load Files", None, QtGui.QApplication.UnicodeUTF8))
        self.lbl_searchType.setText(QtGui.QApplication.translate("Form", "Search type", None, QtGui.QApplication.UnicodeUTF8))
        self.lbl_fileSize.setText(QtGui.QApplication.translate("Form", "File Size", None, QtGui.QApplication.UnicodeUTF8))
        self.lbl_resolution.setText(QtGui.QApplication.translate("Form", "Resolution", None, QtGui.QApplication.UnicodeUTF8))
        self.lbl_colorDepth.setText(QtGui.QApplication.translate("Form", "Color Depth", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.tree_files.headerItem().setText(1, QtGui.QApplication.translate("Form", "queueNumber", None, QtGui.QApplication.UnicodeUTF8))
        self.tree_files.headerItem().setText(2, QtGui.QApplication.translate("Form", "fileNumber", None, QtGui.QApplication.UnicodeUTF8))
        self.tree_files.headerItem().setText(3, QtGui.QApplication.translate("Form", "Project ID", None, QtGui.QApplication.UnicodeUTF8))
        self.tree_files.headerItem().setText(4, QtGui.QApplication.translate("Form", "Simple/Complex", None, QtGui.QApplication.UnicodeUTF8))
        self.tree_files.headerItem().setText(5, QtGui.QApplication.translate("Form", "Original Name", None, QtGui.QApplication.UnicodeUTF8))
        self.tree_files.headerItem().setText(6, QtGui.QApplication.translate("Form", "New Name", None, QtGui.QApplication.UnicodeUTF8))
        self.tree_files.headerItem().setText(7, QtGui.QApplication.translate("Form", "Included/Excluded", None, QtGui.QApplication.UnicodeUTF8))
        self.tree_files.headerItem().setText(8, QtGui.QApplication.translate("Form", "Status", None, QtGui.QApplication.UnicodeUTF8))
